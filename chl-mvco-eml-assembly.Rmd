...
chl_input <- read_excel(here('MVCO_chl_4EDI_copy20220616.xlsx')) 
...
# create dummy depth column # will be unnecessary with new data table
#chl_mvco$depth <- NA_real_
...
excel_to_template(here('nes-lter-chl-mvco-info'), 'nes-lter-chl-mvco', rights='CC0')
